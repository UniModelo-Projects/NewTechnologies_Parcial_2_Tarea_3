...
> **[PEGAR AQUÍ: Captura de pantalla del portal de Azure en la sección 'Repositories' de tu ACR mostrando 'azure-demo-app']**
...
> **[PEGAR AQUÍ: Captura de pantalla de GitHub Actions mostrando el paso "Deploy to Azure Web App" exitoso]**
...
> **[PEGAR AQUÍ: Captura de pantalla del navegador mostrando la app en la URL .azurewebsites.net]**
